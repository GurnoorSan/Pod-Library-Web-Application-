...
@pytest.fixture
def episode():
    episode =Episode(1, 1, "D-Hour Radio Network", episode_audio="test audio", episode_length= 10, episode_desc="test description", upload_date= datetime(2024, 1, 1))
    return episode
...
def test_category_to_dict(empty_memory_repo, category, podcast, podcast_2):
    ...
    assert dict_cate["tagged_podcasts"] == [1]
