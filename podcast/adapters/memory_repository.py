...
class MemoryRepository(AbstractRepository):
    ...
    def get_podcast(self, podcast_id) -> Podcast:
        ...
        try:
            podcast = self.__podcasts_index[podcast_id]
        except KeyError:
    ...
    def add_episode(self, episode: Episode):
        parent = None
        try:
            parent = self.__podcasts_index[episode.podcast_id]
        except KeyError:
            pass
    ...
    def get_episode(self, episode_id) -> Episode:
        ...
        try:
            episode = self.__episodes_index[episode_id]
        except KeyError:
            pass  # Ignore the exception and return None.
